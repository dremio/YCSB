...
public class CloudSpannerClient extends DB {
  ...
  private static final ArrayList<String> NAMESPACES_FIELDS = new ArrayList<>(
      Arrays.asList("DOCUMENT_ID", "ENTITY_TYPE", "ENTITY_ID", "DATASET_UUID", "CONTAINER"));
  ...
  public Status scanWithCreatedTimeFilter(String table, String startRange, String endRange, int recordCount,
    ...
    if (startRange != null && endRange != null) {
      ...
      filterClause.concat(" >= ").concat(startRange).concat(" LIMIT ").concat(Integer.toString(recordCount));

    } else if (endRange != null) {
      filterClause.concat(" <= ").concat(endRange).concat(" LIMIT ").concat(Integer.toString(recordCount));
  ...
  public Status scanWithNamespaceKeyFilter(String table, String startKey, String endKey, int recordCount,
                                           Set<String> fields, Vector<HashMap<String, ByteIterator>> result) {
    String filterClause = "WHERE ID";
    if (startKey != null && endKey != null) {
      filterClause.concat(" BETWEEN ").concat(startKey).concat(" AND ").concat(endKey)
          .concat(" LIMIT ").concat(Integer.toString(recordCount));

    } else if (startKey != null) {
      filterClause.concat(" >= ").concat(startKey).concat(" LIMIT ").concat(Integer.toString(recordCount));

    } else if (endKey != null) {
      filterClause.concat(" <= ").concat(endKey).concat(" LIMIT ").concat(Integer.toString(recordCount));
