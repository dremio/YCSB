...
if __name__ == "__main__":
    ...
    columns = ('jobId', 'allDatasets', 'dataset', 'datasetVersion', 'duration', 'endTime', 'jobResult', 'jobState', 'parentDataset', 'queryType', 'queueName', 'space', 'sql', 'startTime', 'user', 'version')
    records = []
    for d in data:
        job_id = d["jobId"]
        ...
        user = d["user"]
        version = d["version"]
        records.append((job_id, all_ds, dataset, ds_version, duration, end_time, job_result, job_state, parent_ds, query_type,
        ...
        query = "INSERT {} (jobId, allDatasets, dataset, datasetVersion, duration, endTime," \
                ...
                "{}, '{}', {})".format(args.tablename, job_id, all_ds, dataset, ds_version, duration, end_time, job_result, job_state, parent_ds, query_type, queue_name, space, sql, start_time, user, version)
