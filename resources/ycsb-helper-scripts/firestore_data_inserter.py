...
for d in data:
    ...
    if batchCount == batchSize:
        ...
        logging.info("Inserted {} out of {} records into table {} from file {}".format(insertedRecords, totalRecords, args.tablename, args.filename))
        batchCount = 0
if batchCount > 0:
    batch.commit()
    insertedRecords += batchCount
    logging.info("Inserted {} out of {} records into table {} from file {}".format(insertedRecords, totalRecords, args.tablename, args.filename))
logging.info("Successfully inserted {} records into table {} from file {}".format(totalRecords, args.tablename, args.filename))