...
from faker.providers import python, file, misc, internet
import datetime
import argparse
...
def generate_job():
    ...
    QUERY_TYPES = ["UI_RUN", "UI_PREVIEW", "UI_INTERNAL_PREVIEW", "UI_INTERNAL_RUN", "UI_EXPORT", "ODBC", "JDBC", "REST",
                   "ACCELERATOR_CREATE", "ACCELERATOR_DROP", "UNKNOWN", "PREPARE_INTERNAL", "ACCELERATOR_EXPLAIN",
                   "UI_INITIAL_PREVIEW"]
    QUEUE_NAMES = ["Ui Previews", "High Cost Reflections", "Low Cost Reflections", "High Cost User Queries", "Low Cost User Queries"]
