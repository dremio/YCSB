...
public class ScanReadWorkload extends Workload {
  ...
  static {
    try {
      ...
      ROW_TEMPLATE.put("startTime", new ByteArrayByteIterator(Utils.longToBytes(5130)));
